...
console.log(ingredients(practiceIngredients));
...
let katniss = new Cat("Katniss", 12, "pink");
...
let harry = new Wizard("Harry Potter", 17, "Expecto Patronum");
...
let phone2 = new Phone("Samsung", "Galaxy Note", 100, "black", 400);
...
//Code Here
const myFirstVehicle = new Vehicle(4, 'gray', 12000);
...
//Code Here
const myFirstMotorcycle = new Motorcycle(1, 'red', 3000, 'Yamaha', true);
...
//Code Here
const myFirstBoat = new Boat(12, 'black', 2000, 'The Beast', 'speed boat', false);
